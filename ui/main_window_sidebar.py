...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        dock_lo.setContentsMargins(10, 6, 10, 4)
        dock_lo.setSpacing(3)
        ...
        self.profile_btn.setFixedSize(110, 40)
        ...
        status_pill.setFixedSize(150, 40)
        sp_lo = QHBoxLayout(status_pill)
        sp_lo.setContentsMargins(10, 4, 10, 4)
        sp_lo.setSpacing(7)
        ...
        tl_lbl.setStyleSheet(f"color: {C['text']}; font-size: 16px; font-weight: 600;")
        ...
        self.compact_view_btn.setFixedSize(36, 28)
        ...
        self.tl_search.setFixedHeight(28)
