...
def make_playback_panel(window):
    ...
    dlo.setContentsMargins(10, 7, 10, 7)
    dlo.setSpacing(6)
    ...
    def section_title(txt):
        lbl = QLabel(txt)
        lbl.setStyleSheet(
            f"color: {C['text_dim']}; font-size: 9px; font-weight: 950; "
    ...
    self.start_btn.setFixedSize(68, 40)
    self.start_btn.setStyleSheet(
        f"QPushButton#play_btn {{ background-color: #063c1f; color: {C['text']}; "
        f"border: 1px solid {C['success']}; border-radius: 8px; font-size: 11px; font-weight: 950; padding: 0 7px; }}"
    ...
    self.pause_btn.setFixedSize(38, 40)
    ...
    options_section.setFixedWidth(300)
    ...
    self.speed_combo.setFixedSize(74, 27)
    ...
    self.loops_spin.setFixedSize(38, 27)
    ...
    self.inf_check.setFixedSize(28, 27)
    ...
    self.sim_check.setFixedSize(42, 26)
    ...
    self.focus_check.setFixedSize(48, 26)
    ...
    self.collapse_playback_btn.setFixedSize(70, 27)
    self.collapse_playback_btn.setStyleSheet(
        f"QPushButton {{ color: {C['text']}; font-size: 10px; font-weight: 800; "
