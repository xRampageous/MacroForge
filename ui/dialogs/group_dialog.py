...
class GroupDialog(QDialog):
    ...
    def __init__(self, parent=None, existing=None):
        ...
        self.setWindowTitle("Action Folder")
        ...
        lo.setSpacing(12)
        lo.addWidget(make_header("Action Folder", accent, "folder", "Add a visual folder header to organise large macros."))
        ...
        self.name_edit.setPlaceholderText("Folder name")
        ...
        self.recovery = QCheckBox("Recovery folder")
        self.recovery.setToolTip("Recovery folders can be targeted by smart retry/on-fail rules")
        ...
        lo.addWidget(body)
        lo.addLayout(make_buttons(self, "Save Folder", accent, self.accept, "folder"))
